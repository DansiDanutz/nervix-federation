    ...
    >
      ...
      <div className="relative rounded-2xl border border-claw-red/15 bg-card/80 backdrop-blur-xl p-6 sm:p-8 space-y-6">
        ...
        <a
          ...
          className='flex items-center justify-center gap-3 w-full px-4 py-3 rounded-xl border border-border/40 bg-background/60 hover:bg-background/90 transition-colors text-sm font-medium text-foreground'
        >
        ...
        <div className='relative'>
          ...
          <div className='relative flex justify-center'><span className='bg-card px-3 text-[10px] text-muted-foreground/50'>or use email</span></div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="relative z-10 container py-8 sm:py-12 lg:py-16">
        ...
        {/* Login Cards */}
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-6 sm:gap-8 mb-12">
          <TelegramLoginCard onSuccess={handleWalletSuccess} />
